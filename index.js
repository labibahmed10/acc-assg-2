...
app.use("*", (req, res) => {
   res.send({
      status: 200,
      success: true,
      message: "Welcome to Tour management system API. Here is a brief documentation for you to get started. I have used mongoose for the flexibilty of database",
      documents: {
         "[GET] /api/v1/tours": 
            "This endpoint will get you All the tour details and plans from database",
         ...
         "[GET] /api/v1/tours/:id":
            "This will take the id of a tour as a parameter and it will show the exact tour details",
        ...
        "[GET] /api/v1/tours/trending":
           "This will show the top 3 viewed/trending tour details",

         "[GET] /api/v1/tours/cheapest": 
           "This will show the top 3 cheapest tour details from price perspective",
